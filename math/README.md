...
```
  ...
  ─────────────────────────────────────────────────
  🟩 순수 수학:  136개  ← 골든존이 무너져도 영원히 참
  🟦 기존 정리:  17개  ← Heegner + 육각수 + Mihailescu(3²-2³=1)
  ⭐ 대발견:     10개  ← σφ=nτ쌍대 + R간극 + φ=τ유한 + weight=lcm + Möbius 등
...
```
  ...
  ⭐ φ(n)=τ(n) 해 = {3,8,10,18,24,30} — 유한+완전! (10^6 검증+증명)
     → n≥31에서 φ>τ 항상 → 유한성 확정
...
| # | 대상 | 제목 | 상태 | 문서 |
|---|---|---|---|---|
| P-001 | arXiv (math.NT) | σφ=nτ ⟺ n∈{1,6} + 간극 정리 | 📝 구조 확정 | [outline](docs/papers/P-001-sigma-phi-characterization.md) |
