...
1. **쿼크 질량은 post-hoc**: 관측값 보고 공식 맞춤. 사전 예측 아님.
2. **Λ 메커니즘 부재**: 숫자만 맞고 "왜?"는 미답.
3. **라그랑지안 구속항 해석**: λ₁, λ₂가 물리적으로 무엇인지 미정.
4. **up 쿼크 오차 7.4%**: 9개 중 최약.
5. **연속체 한계**: n은 정수인데 장론은 연속 → 정수 격자 장론 필요.
