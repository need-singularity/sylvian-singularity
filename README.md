...
```
         ...
         ┌──────────────┐              ┌──────────────────────┐
         │ 위상적 QFT    │              │    양자 정보이론       │
         │ Witten(1988) │              │  큐빗, 얽힘, 텔레포트  │
         │ Chern-Simons │              │  홀로그래피 원리       │
         └──────────────┘              └──────────┬───────────┘
                                                  ▼
                                       ┌──────────────────────┐
                                       │    양자 카오스         │
  ...
  허브 점수:
    힐베르트 공간 & 리 군/대수 = ★★★★★ (각 6개 연결)
    경로 적분 & 스펙트럼 이론   = ★★★★☆ (각 5개 연결)
    → 양자역학의 골격 = 힐베르트 공간 + 대칭(리 군)
```
...
```
  ...
  통계역학 (분배함수) │ Wick 회전: t → -iτ         │ 경로 적분      │ ★★★★★
  정보이론 (섀넌)     │ S_VN = -Tr(ρ ln ρ) 일반화  │ 양자 정보      │ ★★★★★
  상전이 (임계현상)   │ Wilson RG = 경로적분 축약   │ 재규격화       │ ★★★★★
  군론 (SU,SO)       │ 게이지 군 = 리 군           │ 리 군/대수     │ ★★★★★
  위상수학 (호모토피) │ Witten TQFT, Fields Medal  │ 위상적 QFT     │ ★★★★☆
  복잡계 (Langton)   │ 혼돈의 가장자리 ≈ 양자임계? │ 양자 카오스    │ ★★☆☆☆

  확립: 5개  강증거: 1개  추측: 1개
  → 기존 수학과 양자 수학은 깊이 연결되어 있다
  → 최대 허브(통합): 리만 제타 (기존 8 + 양자 2 = 10개 분야)
```

### 양자 정밀 상수 하이라이트 (가설 250)

```
  상수/수식              │ 이론 vs 실험 일치    │ 프로젝트 연결
  ──────────────────────┼────────────────────┼──────────────────
  α = 1/137.035999...   │ 10자리             │ 가설 147,148 (8×17+1)
  전자 g-2              │ 12자리 (QED 최고)  │ QED=가장 정밀한 이론
  카시미르 효과          │ 1% (진공 에너지)   │ 진공≠무
  CMB = 2.7255K         │ 관측               │ ≈ e (가설 120,131)
  플랑크 흑체복사        │ 정확 (양자역학 탄생)│ I=1/kT 매핑
```
